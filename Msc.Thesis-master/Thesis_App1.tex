...
\begin{table}[h]
	\caption{آزمودن مدل روی یک مکالمه طولانی}
	\label{table:result_general_lc}
	\begin{tabularx}{\linewidth}{LL}
		\hline
		\multicolumn{2}{c}{مدل بارت پیش‌آموزش یافته}                                                                                                                                                                                                                                                          \\ \hline
		Human & \lr{Hello}                                                                                                                                                             \\
		Bot   & \lr{hello}                                                                                                                                            \\
		Human & \lr{I think Moose is a very attractive animal}                                                                                                                                                                                                                                                          \\
		Bot   & \lr{I think they are very cute, they were called Melete or practice }                                                                                                                                                          \\
		Human & \lr{Where do they often live?}                                                                                                                                                                                                                                                             \\
		Bot   & \lr{they are found in Canada, most of the country, northern New England and upstate New York} \\
		Human & \lr{I love that country what do you know about it?}                                                                                                                                                                                                                                                                           \\
		Bot   & \lr{Canada is a country in the northern part of North America }                                                                                                                                                                                                                                    \\
		Human & \lr{what is its capital?}                                                                                                                                                                                                                            \\
		Bot   & \lr{it is a very beautiful country }
		\\
		Human & \lr{I have asked about canada's capital!}
		\\
		Bot   & \lr{canada is a very beautiful country }    
		\\
		Human & \lr{do you know anything about Ottawa?}         
		\\
		Bot   & \lr{Ottawa is the capital of canada } 
		\\
		Human & \lr{Do you remember what animal we were talking about?}
		\\
		Bot   & \lr{the Moose, the most beautiful mammal, the largest animal in canada }                                                                                                                                                                                                                                                                                                                                                                                                                                                          
	\end{tabularx}
\end{table}
